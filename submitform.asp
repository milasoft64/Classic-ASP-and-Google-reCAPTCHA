...
<br><br>
    <div align="center"> 
      <table width="50%" border="0" cellpadding="0" cellspacing="0" bgcolor="#865c0a">
        <tr> 
...
if sname = "" then
response.write "<br><br><center><h4>You didn't enter your name."
err = 1
end if
...
Response.write "<br><br>We'll get back to you if necessary.</div>" 
